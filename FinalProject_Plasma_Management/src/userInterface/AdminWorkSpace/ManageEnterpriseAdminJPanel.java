...
public class ManageEnterpriseAdminJPanel extends javax.swing.JPanel {
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
        ...
        Employee employee = enterprise.getEmployeeDirectory().createEmployee(emailId,enterprise);
        Account account = null;
        if(employee.getRole().equals(Enterprise.EnterpriseType.NGO.getValue()))
        {
          account =   enterprise.getUserAccountDirectory().createUserAccount(userName, password, employee, new NGORole());
        }
        else if(employee.getRole().equals(Enterprise.EnterpriseType.Hospital.getValue()))
        {
          account =   enterprise.getUserAccountDirectory().createUserAccount(userName, password, employee, new AdminRole());
        }
         else if(employee.getRole().equals(Enterprise.EnterpriseType.Laboratory.getValue()))
        {
          account =   enterprise.getUserAccountDirectory().createUserAccount(userName, password, employee, new LabRole());
        }
