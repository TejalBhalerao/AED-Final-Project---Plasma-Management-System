...
import Business.WorkQueue.SysCoordinatorTestWorkRequest;
 ...
 * @author TEJAL
 */
public class DonorsJPanel extends javax.swing.JPanel {

    /**
     * Creates new form DonorsJPanel
     */
    ...
    public DonorsJPanel(UserAccount userAccount, EcoSystem system, Network network) {
        initComponents();
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(jPanel3, javax.swing.GroupLayout.DEFAULT_SIZE, 1541, Short.MAX_VALUE)
    ...
    private void btnAssignActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAssignActionPerformed
        ...
        if (row < 0) {
            ...
            WorkRequest request = new SysCoordinatorTestWorkRequest();

            //if(request.getDonor().getStatus().equals("Government Approved"))
            {
                request.setActDate(new Date());
