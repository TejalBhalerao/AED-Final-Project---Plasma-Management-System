...
public class CommiteeWorkAreaJPanel extends javax.swing.JPanel {
    ...
    public CommiteeWorkAreaJPanel(JPanel rightPanel, Account account, Enterprise enterprise, ECOSystem business) {
        initComponents();
        this.rightPanel = rightPanel;
        this.account = account;
        this.business = business;
    ...
    private void initComponents() {
        ...
        add(btnRefresh, new org.netbeans.lib.awtextra.AbsoluteConstraints(980, 31, -1, 30));
